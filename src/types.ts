...
export interface CachedProposalRecord {
  match_id: string;
  response_id: string;
...
export interface ConfirmedArrangementRecord {
  match_id: string;
  partner_name: string;
  partner_code: string;
...
export interface InquiryRecordV2 {
  ...
  cached_proposal?: CachedProposalRecord | null;
  confirmed_arrangement?: ConfirmedArrangementRecord | null;
}
