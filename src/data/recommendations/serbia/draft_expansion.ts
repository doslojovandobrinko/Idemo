...
export const wave2CanonicalRecommendations: Recommendation[] = [
  {
    ...
    shortDescription:
      "Explore Lazarev Canyon, the deepest and longest canyon in eastern Serbia, coupled with the magnificent caverns of Zlot. A rugged, dramatic karst ecosystem featuring spectacular natural viewpoints, rich biodiversity, and deep prehistoric cave passages.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "Witness the magnificent natural limestone arches of Vratna, some of the highest stone bridges in Europe. Tucked away in a pristine forested valley, this destination offers a silent, deeply spiritual encounter with raw geology.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/a/a6/Prerast_u_kanjonu_Vratne_1.jpg",
    duration: "3-4 hours",
    travelTime: "4 hours",
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "A spectacular driving and hiking route winding through the narrow rock passages of the Jerma River. Bordered by towering cliffs, it leads to medieval monasteries hidden in deep mountain folds.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/f/fb/Reka_Jerma_-_kanjon.jpg",
    duration: "Full day",
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "The 'Stara Planina's Colorado' features extraordinary layered limestone cliffs that resemble stacked pancakes or geological ribs. A short but visually breathtaking walk along a rushing mountain stream.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "An ecological oasis of mystical, deep turquoise waters flowing from a karst cave in eastern Serbia. A refreshing and calming forest walk beneath a canopy of hanging trees and limestone cliffs.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/4/4e/Krupajsko_vrelo_01.jpg",
    duration: "2-4 hours",
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "Walk along Europe's cleanest river, winding through an ecological corridor near Valjevo. Features clear water pools, traditional mills, and isolated karst caves.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/6/60/Kanjon_Reke_Gradac.jpg",
    duration: "Half day",
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "An immersive outdoor day in the 'Serbian Mount Athos' gorge. Combines hiking through dramatic river bends with visits to monasteries hidden in dense forest.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "Stand on the newly designed glass-deck lookout perched atop Kablar Mountain. Offers a breathtaking vertical vista of the West Morava's curved meanders and the surrounding valley.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "Journey into Serbia's most forested UNESCO Biosphere Reserve. A haven of deep fir and spruce woods, cold rivers, and traditional highland villages where life moves slowly.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "Walk among the strange, wave-like grass hills of the Deliblato Sands. This ancient dune system looks like a rolling green carpet straight out of a dream.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/c/c5/Zagajicka_brda.jpg",
    duration: "4-5 hours",
    travelTime: "1.5 hours",
    travelTimeMinutes: 90,
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "A spectacular wetland reserve in Vojvodina hosting hundreds of rare migratory bird species. Enjoy quiet boat rides and photography among fields of water lilies.",
    longDescription:
    ...
    image:
      "/src/assets/images/carska_bara_wetlands_birds_aerial_1778846483752.webp",
    duration: "Half day",
    travelTime: "1 hour",
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "One of Europe’s oldest protected reserves, located just an hour from Belgrade. A peaceful oxbow lake rich in oak forests, birds, and water lilies.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "Witness the ruins of Maglič Castle perched spectacularly on a rocky ridge high above the winding Ibar River. A dramatic medieval landscape full of history and wild peaks.",
    longDescription:
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/e/e0/Maglic_01.jpg",
    duration: "3-4 hours",
    travelTime: "3 hours",
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "A gentle walking trail in Tara National Park linking the historical Rača Monastery to clear mountain springs. Blends dense woodlands with medieval monastic literacy lore.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.NATURE,
    shortDescription:
      "A curated multi-stop nature circuit winding through eastern Serbia's dense forests, limestone cliffs, and rushing water springs.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Discover the remnants of Vojvodina's most significant medieval fortress, dating back to the 14th century. Features a striking, preserved brick keep surrounded by historical plains.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/d/d7/Tvr%C4%91ava_u_Ba%C4%8Du.jpg",
    duration: "Half day",
    travelTime: "2 hours",
    travelTimeMinutes: 120,
    location: "Bač",
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "A massive 16th-century Ottoman fortification on the banks of the Danube River in Kladovo. Blends military history with scenic river views at the border with Romania.",
    longDescription:
  ...
  },
  {
    id: "120",
    title:
      "A Danube Afternoon Beyond Belgrade (Smederevo Fortress + River Evening)",
    category: Category.HISTORY,
    shortDescription:
      "Explore the colossal 15th-century Smederevo Fortress, one of Europe's largest flatland fortifications. Walk atop its massive brick towers as the sun sets over the Danube.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/5/5a/Smederevo_Fortress_Danube.jpg",
    duration: "Half day",
    travelTime: "1 hour",
    travelTimeMinutes: 60,
    location: "Smederevo",
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "A deep cultural pilgrimage tracing the foundations of the medieval Serbian state through royal monasteries hidden in mountain valleys.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "Stand inside the oldest intact Christian church in Serbia, surrounded by the ruins of the medieval capital fortress of Ras.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/1/1b/Petrova_crkva_Novi_Pazar.jpg",
    duration: "Half day",
    travelTime: "4 hours",
    travelTimeMinutes: 240,
    location: "Novi Pazar",
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "Immerse yourself in a lively, historic city blending Ottoman architecture, busy bazaars, traditional hammams, and authentic culinary specialties.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/2/2e/Altun-alem_d%C5%BEamija.jpg",
    duration: "Full day",
    travelTime: "4 hours",
    travelTimeMinutes: 240,
    location: "Novi Pazar",
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "An architectural route through Subotica’s vibrant, colorful Secessionist facades and the beautifully restored Art Nouveau Synagogue.",
    longDescription:
  ...
  },
  {
    id: "125",
    title:
      "Royal Serbia in Half a Day (Oplenac + Royal Heritage + Historic Winery)",
    category: Category.HISTORY,
    shortDescription:
      "Visit the spectacular white-marble royal mausoleum of the Karađorđević dynasty in Topola, boasting one of the world's largest collections of mosaic art.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "A narrative cultural route exploring the layered historical memories of southern Serbia's largest city, from Roman imperial heritage to dark modern memories.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "Follow the ancient northern border of the Roman Empire along the Danube. Visited sites include Viminacium's archaeological ruins and Trajan's Bridge.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "A selected, non-exhaustive monastic route through Fruška Gora National Park, visiting historic orthodox sanctuaries nestled in forest folds.",
    longDescription:
    ...
    image:
      "/src/assets/images/fruska_gora_monastery_vineyard_1778842911981.webp",
    duration: "Half day",
    travelTime: "1 hour",
    travelTimeMinutes: 60,
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "A carefully curated medieval heritage route guiding you through lesser-known, isolated fortifications and architectural treasures.",
    longDescription:
  ...
  },
  {
    id: "130",
    title:
      "The Architecture of Yugoslav Belgrade (Modernist Architecture Route)",
    category: Category.HISTORY,
    shortDescription:
      "Discover the colossal, bold concrete architecture of New Belgrade and Belgrade's center, tracing socialist modernist and brutalist monuments.",
    longDescription:
  ...
  },
  {
    id: "131",
    title:
      "The City that Built Modern Serbia (Kragujevac Industrial-Modernist Story)",
    category: Category.HISTORY,
    shortDescription:
      "Uncover Kragujevac’s fascinating historical layers, from the 19th-century industrial complexes to the monumental memorial parks of the Yugoslav era.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/6/66/Kragujevac_Prva_gimnazija.jpg",
    duration: "Half day",
    travelTime: "1.5 hours",
    travelTimeMinutes: 90,
    location: "Kragujevac",
  ...
  },
  {
    ...
    shortDescription:
      "A timeless village of 270 hand-carved stone cellars dedicated exclusively to wine. Taste local Prokupac and Tamjanika in medieval atmospheric stone vaults.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Rogljevo’s authentic, preserved limestone wine cellars offer an alternative, highly intimate tasting environment less crowded than Rajac.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/5/54/Rogljeva%C4%8Dke_pivnice.jpg",
    duration: "2-3 hours",
    travelTime: "4 hours",
    travelTimeMinutes: 240,
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Taste elegant, local wines produced by orthodox monks within the serene courtyards of the historic Bukovo Monastery.",
    longDescription:
    ...
    image:
      "/src/assets/images/serbian_boutique_distillery_rakija_1778846500524.webp",
    duration: "2 hours",
    travelTime: "3.5 hours",
    travelTimeMinutes: 210,
    location: "Near Negotin",
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Taste Bermet—the sweet, herbal wine once served on the Titanic—in the colorful, baroque wine estates of Sremski Karlovci.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Immerse yourself in Župa, the historical home of Tamjanika. Taste floral white wines and rich Prokupac reds directly at the vineyards.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Discover Toplica, a emerging southern wine region focusing on organic, complex expressions of Serbia's flagship native red grape, Prokupac.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Witness a spectacular, strictly seasonal autumn tradition where entire village houses are completely covered in hanging red pepper chains.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/3/3d/Donja_Lokosnica_paprika.jpg",
    duration: "2-3 hours",
    travelTime: "3 hours",
    travelTimeMinutes: 180,
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Savor the unique gastronomy of southeastern Serbia. Highlights include ironed sausage (peglana), Sabor cheese, and handmade wool kilims (Pirot carpets).",
    longDescription:
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "An authentic, hearty culinary morning on Serbia’s cold highland plateau. Savor Sjenica cheese, fresh clotted cream (kajmak), and traditional buckwheat pies.",
    longDescription:
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/e/e4/Pester_plateau.jpg",
    duration: "3 hours",
    travelTime: "4 hours",
    travelTimeMinutes: 240,
  ...
  },
  {
    ...
    category: Category.GASTRONOMY,
    shortDescription:
      "Discover the generation-old clay pottery village of Zlakusa. Watch potters shape pots manually, then dine on meat slow-cooked in these clay vessels.",
    longDescription:
  ...
  },
  {
    id: "143",
    title:
      "Belgrade Through an Architect’s Eyes (Focused Design and Modernism Route)",
    category: Category.TRAVEL,
    shortDescription:
      "A curated walking tour focusing on Belgrade’s design evolution, from Art Nouveau details to brutalist housing blocks and modern galleries.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.HISTORY,
    shortDescription:
      "Witness the illuminated Art Nouveau masterpieces of Subotica under soft evening lights, followed by a quiet, refined dinner.",
    longDescription:
      "At sunset, Subotica's spectacular City Hall, Synagogue, and Secessionist facades are illuminated with warm, architectural spotlights. This creates a peaceful, deeply cinematic design walk, best finished with a glass of native wine and slow dinner in an elegant northern setting.",
    image: "/src/assets/images/subotica_palic_lake_villa_1778843996440.webp",
    duration: "3 hours",
    travelTime: "2 hours",
    travelTimeMinutes: 120,
  ...
  },
  {
    id: "145",
    title:
      "Gorge, Water and Thermal Rest (Ovčar Banja Combined with Ovčar-Kablar)",
    category: Category.WELLBEING,
    shortDescription:
      "A slow, healing day in the green heart of Ovčar Gorge. Combine mild scenic hiking with peaceful thermal baths nestled beneath towering mountains.",
    longDescription:
  ...
  },
  {
    id: "146",
    title:
      "A Weekend Above the Noise (Lukovska Banja Mountain Thermal Retreat)",
    category: Category.WELLBEING,
    shortDescription:
      "Relax in Serbia’s highest thermal resort, perched at 681m on the slopes of Kopaonik. Features hot spring pools surrounded by clean alpine air and snow.",
    longDescription:
  ...
  },
  {
    ...
    category: Category.TRAVEL,
    shortDescription:
      "A picturesque Danube lakeside escape featuring the magnificent 15th-century Ram Fortress perched atop steep river cliffs, offering unforgettable sunset views across the water.",
    longDescription:
