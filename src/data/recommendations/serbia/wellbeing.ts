...
export const wellbeingRecommendations: Recommendation[] = [
  {
    ...
    translations: {
      sr: {
        title: "Vrnjačka Banja",
        shortDescription:
          "Kraljica srpskih banja sa tradicijom još iz rimskih vremena i sedam mineralnih izvora.",
        longDescription:
          "Vrnjačka Banja je najpoznatije banjsko mesto u Srbiji, sa tradicijom lečenja koja datira još od vremena cara Konstantina. Pored lekovitih izvora, nudi luksuzne wellness centre i prelepe parkove idealne za šetnju. Čuvena je i po 'Mostu ljubavi' gde je tradicija zaključavanja katanaca i počela.",
  ...
  },
  {
    ...
    category: "Wellbeing",
    shortDescription:
      "A blend of thermal recovery in Sokobanja and the mystical energy of the pyramid-shaped Rtanj Mountain. A hotspot for alternative wellness.",
    longDescription:
