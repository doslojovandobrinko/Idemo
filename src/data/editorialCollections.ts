...
export const INITIAL_EDITORIAL_COLLECTIONS: EditorialCollection[] = [
  {
    ...
    subtitleEn: "Belgrade as a Pivot of International Non-Alignment and Cold War Geopolitics",
    subtitleSr: "Beograd kao težište međunarodnog nesvrstavanja i hladnoratovske geopolitike",
...
Diplomatska arhitektura Beograda namenski je građena da izrazi suverenitet i međunarodno angažovanje. Od Dedinja do monumentalnog urbanizma Novog Beograda, izgrađeno okruženje fizički je odražavalo ulogu posrednika između suprotstavljenih sila.`,
    heroImage: "/src/assets/images/bitef_theatre_belgrade_modern_1778847369770.webp",
    gallery: [
    ...
    visitorTakeawayEn: "Visitors completing this collection gain a nuanced understanding of how Belgrade served as a neutral diplomatic crossroads during the Cold War. The journey reveals how statecraft, modernist architecture, and urban planning merged to create a unique spatial canvas for twentieth-century global diplomacy.",
    visitorTakeawaySr: "Posetioci kroz ovu kolekciju stiču duboko razumevanje Beograda kao neutralnog diplomatskog raskršća tokom Hladnog rata i spoja arhitekture i diplomatije.",
    journeyRationale: {
      "130": "Primary institutional archive and modernist administrative complex documenting 20th-century state visits and diplomatic assemblies.",
      ...
      "PKG-024": "Royal spa retreat patronized by 19th-century Serbian dynasties and historic fin-de-siècle diplomatic leisure sanctuary."
    },
    isPublished: true
  },
  {
    ...
    titleZh: "塞尔维亚与不结盟运动",
    subtitleEn: "The Heritage of the 1961 Belgrade Summit and Transcontinental Cooperation",
    subtitleSr: "Nasleđe Beogradskog samita 1961. godine i transkontinentalne saradnje",
...
This collection guides visitors through the key sites associated with the founding of NAM. Through state gift collections, commemorative public spaces, and modernist administrative monuments, the journey presents the history of the movement through verifiable cultural heritage and architectural legacy, offering an objective look at one of the twentieth century's most significant international initiatives.`,
    ...
    visitorTakeawayEn: "After experiencing this collection, visitors will appreciate Belgrade's historical role as the birthplace of the Non-Aligned Movement. The route illuminates how mid-century geopolitical initiatives shaped physical public spaces, diplomatic gift traditions, and cross-cultural institutions that endure in the city today.",
    visitorTakeawaySr: "Nakon ove kolekcije, posetioci razumeju istorijsku ulogu Beograda kao mesta rođenja Pokreta nesvrstanih i njegov uticaj na javni prostor i kulturne institucije.",
    journeyRationale: {
      "130": "Houses state gift archives, protocol materials, and administrative spaces of the inaugural 1961 Belgrade Summit.",
  ...
  },
  {
    ...
    titleZh: "三信仰之地的塞尔维亚",
    subtitleEn: "A Journey Through Centuries of Orthodox, Islamic, and Jewish Sacred Heritage",
    subtitleSr: "Putovanje kroz vekove pravoslavnog, islamskog i jevrejskog svetog nasleđa",
...
Beyond individual monuments, this collection illuminates the shared urban fabric of Serbian towns and cities, where minarets, bell towers, and synagogue domes shaped historical skyline vistas. Visiting these sacred spaces provides visitors with a thoughtful perspective on the multicultural tapestry and religious tolerance that have defined the historical character of the region.`,
    ...
    heroImage: "/src/assets/images/saint_sava_temple_interior_1778845911761.webp",
    gallery: [
    ...
    visitorTakeawayEn: "Travelers completing this journey will gain a profound appreciation for Serbia’s rich interfaith heritage. Exploring these sacred landmarks highlights how Orthodox, Islamic, and Jewish communities cultivated distinct yet intertwined artistic and architectural legacies across the Balkans.",
    visitorTakeawaySr: "Putnici kroz ovu kolekciju stiču duboko poštovanje prema bogatom međukonfesionalnom nasleđu Srbije i prepletenim umetničkim tradicijama.",
    journeyRationale: {
      "54": "One of the world's largest Orthodox temples, featuring 15,000 square meters of Serbo-Byzantine gold mosaic art.",
      "124": "Masterpiece of Art Nouveau sacral architecture, featuring hand-painted Zsolnay ceramic tiles and stained glass.",
      "123": "Centuries-old Ottoman sacred architecture including the Altun-Alem mosque and traditional hammam masonry.",
  ...
  },
  {
    ...
    titleZh: "罗马皇帝的塞尔维亚",
    subtitleEn: "Imperial Palaces, Castra, and Mosaics Across the Birthland of Eighteen Roman Rulers",
    subtitleSr: "Carski dvorci, kastrumi i mozaici u zavičaju osamnaest rimskih imperatora",
...
Further east, the UNESCO World Heritage site of Felix Romuliana showcases the fortified retirement palace of Emperor Galerius, decorated with pristine floor mosaics of Dionysus and Hercules. In the south, Mediana presents the luxurious villa suburbana of Constantine the Great. This collection offers an unparalleled journey through late antique statecraft, military engineering, and imperial art.`,
    ...
    recommendedSeason: ["Spring", "Summer", "Autumn"],
    estimatedBudget: "Moderate",
    geographicScope: "Sirmium (Sremska Mitrovica), Viminacium, Mediana (Niš), Felix Romuliana (Zaječar)",
    recommendationIds: [
      "17",
      "16",
      "49",
    ...
    recommendedOrder: [1, 2, 3, 4, 5, 6],
    visitorTakeawayEn: "Completing this imperial route reveals Serbia's vital role in shaping the Late Roman Empire. Visitors discover how Illyrian-born emperors transformed military frontiers into grand architectural hubs of power, law, and artistic patronage.",
    visitorTakeawaySr: "Ova carska ruta otkriva ključnu ulogu Srbije u oblikovanju Poznog rimskog carstva i transformaciji vojnih granica u centre moći i umetnosti.",
    journeyRationale: {
      ...
      "49": "Suburban imperial estate of Constantine the Great in ancient Naissus, featuring more than 1,000 m² of preserved Roman mosaics.",
      "45": "Ottoman ramparts standing upon ancient Roman Naissus foundations in the birthplace of Constantine the Great.",
      "PKG-007": "UNESCO-listed imperial palace complex of Emperor Galerius featuring monumental fortification towers, world-class floor mosaics, and Negotin stone wine cellars.",
      "PKG-016": "Birthplace of Constantine the Great featuring more than 1,000 m² of preserved Roman mosaics, Ottoman fortress ramparts, and Ćele Kula."
    },
    isPublished: true
  },
  {
    ...
    titleZh: "隐藏的贝尔格莱德",
    subtitleEn: "Secret Passages, Atmospheric Quarters, and the Everyday Soul of the Capital",
    subtitleSr: "Tajni prolazi, atmosferske četvrti i svakodnevna duša prestonice",
...
Below the pavement lies Underground Belgrade—a subterranean labyrinth of Roman gunpowder stores, Austrian military tunnels, and Cold War bunkers carved into the limestone bedrock. This collection invites travelers to slow down, explore hidden passageways, and experience the authentic, everyday rhythm of one of Europe’s most resilient cities.`,
    ...
    recommendedSeason: ["Spring", "Summer", "Autumn", "Winter"],
    estimatedBudget: "Moderate",
    geographicScope: "Belgrade (Zemun, Kosančićev Venac, Dorćol, Savamala, Tašmajdan)",
    recommendationIds: [
      "51",
      "58",
      "23",
    ...
    recommendedOrder: [1, 2, 3, 4],
    visitorTakeawayEn: "Visitors completing Hidden Belgrade gain an authentic connection to the capital’s inner character. Moving beyond tourist landmarks, the experience reveals how hidden courtyards, subterranean spaces, and neighborhood traditions sustain the living spirit of Belgrade.",
    visitorTakeawaySr: "Posetioci kroz Skriveni Beograd ostvaruju autentičnu vezu sa duhom grada, otkrivajući dvorišta, podzemne prolaze i živopisne komšijske tradicije.",
    journeyRationale: {
