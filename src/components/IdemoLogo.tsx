...
export default function IdemoLogo({
  ...
  return (
    ...
    >
      ...
      {/* Letter E */}
      <path d="M 320 70 H 430 V 106 H 356 V 132 H 415 V 168 H 356 V 194 H 430 V 230 H 320 Z" fill="#000000" />
      
      {/* Letter M */}
      <path d="M 460 230 V 70 H 496 L 535 165 L 574 70 H 610 V 230 H 574 V 115 L 535 210 L 496 115 V 230 Z" fill="#000000" />
      
      {/* Letter O (Clean Elegant Ring) */}
      <circle cx="720" cy="150" r="62" stroke="#000000" strokeWidth="36" fill="none" />
    </svg>
  );
}
