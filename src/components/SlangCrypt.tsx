...
import { BookOpen, Sparkles, CheckCircle, AlertTriangle, HelpCircle } from 'lucide-react';
...
export function SlangCrypt({ language }: { language: string }) {
  ...
  const uiLabels: Record<string, any> = {
    en: {
      ...
      subtitle: "A curated collection of cultural formulas, idiomatic nuances, and unspoken rules for the discerning traveler.",
    ...
    sr: {
      ...
      subtitle: "Prečišćena zbirka kulturnih formula, idiomatskih nijansi i neobaveznih pravila za prefinjenog putnika.",
      pronounced: "IZGOVOR:",
    ...
    es: {
      ...
      subtitle: "Un compendio selecto de modismos, matices locales y normas tácitas para el viajero exigente.",
    ...
    de: {
      ...
      subtitle: "Eine erlesene Sammlung kultureller Redewendungen, Nuancen und ungeschriebener Regeln für kultivierte Reisende.",
    ...
    ru: {
      ...
      subtitle: "Кураторское собрание идиоматических нюансов, культурных кодов и негласных правил для взыскательного путешественника.",
    ...
    zh: {
      title: "贝尔格莱德社交流量法典",
      subtitle: "为品位非凡的行者专属定制的民俗术语、地道语境与无形社交礼仪指南。",
      pronounced: "发音指南：",
      literal: "原意与释义",
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xl font-serif text-brand-charcoal tracking-tight">{l.title} 🇷🇸</h3>
        </div>
      ...
      <div className="relative -mx-6">
        <PremiumCarousel
          ...
          renderItem={(term, isCenter) => {
            ...
            return (
              <div className={`h-[560px] p-5.5 rounded-[32px] flex flex-col justify-between text-left group transition-all duration-300 ${
                isCenter 
                ...
                <div className="space-y-4 overflow-y-auto no-scrollbar flex-1 pb-2">
                  <div className="flex justify-between items-start border-b border-border-main/10 pb-3">
                    <div>
                      <span className="text-3xl font-serif text-brand-charcoal font-black tracking-tight">{term.cyrillic}</span>
                      <span className="text-xs text-brand-charcoal/40 font-mono italic ml-2">({term.word})</span>
                    </div>
                  ...
                  {/* Pronunciation block */}
                  <div className="flex items-center gap-2">
                    <span className="text-[12px] uppercase font-black tracking-widest text-[#8C8A7D] font-mono leading-none">{l.pronounced}</span>
                  ...
                  {/* Translation block */}
                  <div className="space-y-1">
                    <h5 className="text-[13.5px] uppercase tracking-widest text-[#8C8A7D] font-black">{l.literal}</h5>
                  ...
                  {/* Nuance block */}
                  <div className="space-y-1">
                    <h5 className="text-[13.5px] uppercase tracking-widest text-[#8C8A7D] font-black">{l.concierge_spirit}</h5>
                  ...
                  <div className="p-4 bg-brand-pearl/50 border border-border-main/40 rounded-2xl space-y-2">
                    <div className="flex justify-between items-center">
                      <h6 className="text-[12px] font-bold uppercase tracking-widest text-[#8C8A7D]">{l.example_title}</h6>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handleCopyExample(term.example[language] || term.example.en);
                        }}
                ...
                <div className="pt-3 border-t border-[#F1EFE9] space-y-3">
                  <div className={`p-3 rounded-2xl border flex gap-2.5 items-start ${t_localColors[term.id] || "bg-[#FAF9F5] border-border-main/50 text-[#8C8A7D]"}`}>
                    <AlertTriangle size={15} className="shrink-0 mt-0.5" />
                    <div className="space-y-1 flex-1">
                      <span className="text-[13.5px] uppercase font-black tracking-widest block leading-none">{l.etiquette_oath}</span>
                  ...
                  >
                    <CheckCircle size={12} className={isPledged ? 'text-white' : 'text-[#2D3025]/20'} />
