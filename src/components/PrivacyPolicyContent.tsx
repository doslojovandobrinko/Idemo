        ...
        <div className="space-y-3 pt-2">
          <div>
            ...
            <ul className="list-disc pl-4 space-y-1 mt-1 text-[#5C5E54]">
              <li>IDEMO ne zahteva registraciju korisnika ili kreiranje stalnog naloga.</li>
              <li>Aplikacija je primarno dizajnirana da radi bez prikupljanja ličnih podataka za pregled preporuka i korišćenje lokacijskih funkcija.</li>
              <li><strong>Upiti za konsijerž usluge:</strong> Kada dobrovoljno podnesete zahtev za organizaciju doživljaja ili aranžman putem forme za konsijerž, informacije koje pružite (kao što su vaše ime, e-pošta, broj telefona, željeno vreme i posebni zahtevi) prenose se na našu bazu podataka isključivo u svrhu obrade, koordinacije i realizacije vašeg upita.</li>
              <li>Osim za potrebe realizacije podnetih konsijerž upita ili kada je izričito navedeno u ovoj Politici privatnosti, IDEMO ne prikuplja, ne prodaje, ne iznajmljuje niti deli lične podatke sa trećim stranama u marketinške svrhe.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-4 space-y-1 mt-1 text-[#5C5E54]">
              <li>Korisnici imaju pravo da u bilo kom trenutku zatraže trajno brisanje svih podnetih konsijerž upita i pripadajućih ličnih kontakt podataka sa naših servera i baza podataka.</li>
              <li>Da biste podneli zahtev za brisanje, pošaljite e-poštu na <a href="mailto:idemoconsierge@gmail.com" className="text-accent-teal hover:underline font-bold">idemoconsierge@gmail.com</a> sa naslovom „Zahtev za brisanje konsijerž upita“ i navedite e-poštu ili broj telefona koji ste koristili prilikom podnošenja upita.</li>
              <li>Nakon prijema verifikovanog zahteva, IDEMO podrška će trajno izbrisati ili anonimizovati vaše podatke u zakonski predviđenom roku.</li>
            </ul>
          </div>
          ...
          <div className="bg-[#FAF9F5] p-3 rounded-xl border border-border-main/50 space-y-1">
            ...
            <p className="text-[#5C5E54]">Ako imate pitanja ili želite da zatražite brisanje podnetih upita, kontaktirajte:</p>
        ...
        <div className="space-y-3 pt-2">
          <div>
            ...
            <ul className="list-disc pl-4 space-y-1 mt-1 text-[#5C5E54]">
              ...
              <li>本应用主要在本地运行，用于浏览推荐和使用定位功能，无需收集个人身份信息。</li>
              <li><strong>专属管家咨询数据：</strong> 当您主动通过管家咨询/SOS协助表单提交体验预约或咨询请求时，您所提供的信息（如姓名、电子邮箱、电话号码、期望时间及特殊需求）将被传输至我们的后台数据库，仅用于处理、协调与答复您的咨询。</li>
              <li>除非用于完成您提交的管家咨询或本隐私政策中明确说明，否则 IDEMO 绝不将您的个人数据用于广告营销，亦不向第三方出售或出租。</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-4 space-y-1 mt-1 text-[#5C5E54]">
              <li>用户有权随时请求永久删除其提交的所有管家咨询记录及相关个人联系信息。</li>
              <li>如需提交删除申请，请发送电子邮件至 <a href="mailto:idemoconsierge@gmail.com" className="text-accent-teal hover:underline font-bold">idemoconsierge@gmail.com</a>，邮件主题请注明“删除管家咨询申请”，并提供您提交咨询时所使用的电子邮箱或电话号码。</li>
              <li>在收到验证后的删除请求后，IDEMO 客服团队将在法定时限内从后台数据库中永久删除或匿名化您的咨询记录。</li>
            </ul>
          </div>
          ...
          <div className="bg-[#FAF9F5] p-3 rounded-xl border border-border-main/50 space-y-1">
            ...
            <p className="text-[#5C5E54]">如果您有任何疑问或希望申请删除已提交的咨询记录，请随时联系：</p>
            <p className="text-[#5C5E54]">
    ...
    <div className="space-y-4 text-left font-sans text-brand-charcoal/80 leading-relaxed text-[11px]">
      ...
      <div className="space-y-3 pt-2">
        <div>
          ...
          <ul className="list-disc pl-4 space-y-1 mt-1 text-[#5C5E54]">
            <li>IDEMO does not require mandatory user registration or account creation to browse recommendations or use location-based features.</li>
            <li>The application is designed to operate primarily on-device without collecting personally identifiable information.</li>
            <li><strong>Concierge Inquiry Data:</strong> When you voluntarily submit a request via the Concierge Request or SOS assistance forms, the information you provide (such as your name, email address, phone number, preferred time, and special requests) is transmitted to our backend database solely to process, coordinate, and fulfill your inquiry.</li>
            <li>Unless explicitly needed to fulfill your submitted Concierge request or required by law, IDEMO does not share your personal details with third-party advertisers or data brokers.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-4 space-y-1 mt-1 text-[#5C5E54]">
            <li>Users have the explicit right to request the permanent deletion or erasure of any submitted Concierge inquiries and associated contact details from our databases at any time.</li>
            <li>To submit a deletion request, email us at <a href="mailto:idemoconsierge@gmail.com" className="text-accent-teal hover:underline font-bold">idemoconsierge@gmail.com</a> with the subject "Concierge Inquiry Deletion Request", specifying the email address or phone number used when submitting your inquiry.</li>
            <li>Upon receiving and verifying your request, IDEMO support will permanently delete or anonymize your records from backend storage within standard statutory response windows.</li>
          </ul>
        </div>
        ...
        <div className="bg-[#FAF9F5] p-3 rounded-xl border border-border-main/50 space-y-1">
          ...
          <p className="text-[#5C5E54]">If you have questions regarding this Privacy Policy or wish to request deletion of your submitted inquiries, please contact:</p>
          <p className="text-[#5C5E54]">
            Email: <a href="mailto:idemoconsierge@gmail.com" className="text-accent-teal hover:underline font-bold">idemoconsierge@gmail.com</a>
          </p>
          <p className="text-[#5C5E54]">
