...
export function PartnerEditorModal({
  ...
  const [lifecycleStage, setLifecycleStage] =
    useState<PartnerLifecycleStage>("Active");
  ...
  const [activeTab, setActiveTab] = useState<
    "info" | "contact" | "routing" | "governance"
  >("info");
  ...
  useEffect(() => {
    if (initialPartner) {
      ...
      else if (initialPartner.conciergeRoutingEligible === "Yes")
        setLifecycleStage("Active");
      else if (vStatus.includes("verified") || vStatus.includes("Verified"))
        setLifecycleStage("Approved");
      else if (vStatus.includes("unverified") || vStatus.includes("Review"))
        setLifecycleStage("Verification");
      else setLifecycleStage("Candidate");

      setExpertiseInput((initialPartner.expertise || []).join("\n"));
      setLinkedRecsInput(
        (initialPartner.linkedRecommendations || []).join("\n"),
      );
    } else {
      setForm({
        id: `P-${Math.floor(100 + Math.random() * 900)}`,
  ...
  const currentPartnerState: Partial<Partner> = {
    ...
    linkedRecommendations: linkedRecsInput
      .split("\n")
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedExpertise = expertiseInput
      .split("\n")
      .map((s) => s.trim())
      .filter(Boolean);
    const updatedLinkedRecs = linkedRecsInput
      .split("\n")
      .map((s) => s.trim())
      .filter(Boolean);
    ...
    const updatedPartner: Partner = {
      ...
      conciergeRoutingEligible:
        lifecycleStage === "Active" ? "Yes" : "Pending qualification",
        ...
        >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={form.nameSr || ""}
                    onChange={(e) =>
                      setForm({ ...form, nameSr: e.target.value })
                    }
                ...
                <div>
                  ...
                  >
                    <option value="Individual">
                      Individual Guide / Local Artisan
                    </option>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-[#FAF9F5] rounded-2xl border border-[#E5E3DB] space-y-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, directBookingUrl: e.target.value })
                  }
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setForm({ ...form, directBookingNotes: e.target.value })
                  }
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 font-mono text-xs">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNotificationFrequency(e.target.value as any)
                      }
                      className="w-full h-9 px-3 bg-white border border-[#E5E3DB] rounded-xl font-bold text-[#1E2E20]"
                    >
                      ...
                      <option value="Daily Digest">
                        Daily Digest Summary (20:00 UTC)
                      </option>
                    </select>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#8C8A7D] font-mono mt-1">
                  When travelers query these recommendation items, this partner
                  receives direct routing priority.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-[#FAF9F5] border border-[#E5E3DB] rounded-2xl space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setForm({
                          ...form,
                          conciergeRoutingEligible: e.target.value,
                        })
                      }
                  ...
                  <p className="text-[10.5px] text-[#8C8A7D] font-mono">
                    Enables automated traveler inquiry matching via edge
                    functions.
                  </p>
                </div>
                ...
                <div className="p-4 bg-[#FAF9F5] border border-[#E5E3DB] rounded-2xl space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setForm({
                          ...form,
                          directContactAvailable: e.target.value,
                        })
                      }
                      className="h-8 px-2 bg-white border border-[#E5E3DB] rounded-lg text-xs font-mono font-bold"
                    >
                  ...
                  <p className="text-[10.5px] text-[#8C8A7D] font-mono">
                    Displays verified direct contact badges on public experience
                    details.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setForm({ ...form, verificationDetails: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  type="date"
                  value={
                    form.lastVerified || new Date().toISOString().split("T")[0]
                  }
                  onChange={(e) =>
                    setForm({ ...form, lastVerified: e.target.value })
                  }
          ...
          <div className="p-5 bg-white border border-[#E5E3DB] rounded-2xl space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2 mt-0.5">
                    ...
                    <span className="font-mono text-xs text-[#8C8A7D]">
                      ({readiness.completedItems.length} of{" "}
                      {readiness.items.length} criteria satisfied)
                    </span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2 text-xs font-mono border-t border-[#E5E3DB]">
                <div>
                  <span className="font-bold text-[#2E7D32] flex items-center gap-1 mb-1.5 text-[10.5px] uppercase">
                    <CheckCircle2 size={13} /> Satisfied Criteria (
                ...
                <div>
                  ...
                  {readiness.missingItems.length > 0 ? (
                    ...
                    <p className="text-[11px] text-[#2E7D32] italic">
                      Partner profile meets all 10 readiness requirements.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="font-bold text-[#1E2E20] block">
                    Concierge Routing & Activation Status
                  </span>
            ...
            <p className="text-[10px] text-[#8C8A7D] font-mono italic text-center">
              * Note: Partner routing readiness evaluates profile completeness.
              A partner does not become routable solely because the score is
              high; existing verification and routing rules remain
              authoritative.
            </p>
          </div>
