    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-[#8C8A7D] text-xs sm:text-sm font-sans mt-0.5">
          Real-time verification of Supabase integration, Edge Functions, and
          core engine immutability.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-[#E5E3DB] shadow-xs">
          ...
          <p className="text-xl font-serif font-bold text-[#1E2E20] mt-3">
            Connected
          </p>
          <span className="text-[10.5px] font-mono text-[#2E7D32] font-semibold">
      ...
      <div className="bg-white border border-[#E5E3DB] rounded-3xl p-6 shadow-xs space-y-4">
        ...
        <div className="space-y-2.5 font-mono text-xs">
          {[
            {
              time: "2026-08-01 09:40:00 UTC",
              event: "IDEMO Studio Foundation Shell initialized",
              status: "SUCCESS",
              source: "StudioAuthShell",
            },
            {
              time: "2026-08-01 09:30:00 UTC",
              event: "Supabase Production Foundation Audit verified",
              status: "READ_ONLY",
              source: "WP-01 Audit",
            },
            {
              time: "2026-08-01 09:15:00 UTC",
              event: "Destination Package Manager SHA-256 validation",
              status: "SUCCESS",
              source: "packageManager.ts",
            },
            {
              time: "2026-08-01 09:00:00 UTC",
              event: "System watchdog heartbeat check",
              status: "HEALTHY",
              source: "EdgeWorker",
            },
          ].map((log, idx) => (
            <div
              key={idx}
              className="p-3 bg-[#FAF9F5] border border-[#E5E3DB] rounded-xl flex items-center justify-between gap-4"
            >
