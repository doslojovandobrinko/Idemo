...
const ZONES = [
  { id: 'red', name: { en: 'Red Zone (Zone 1)', sr: 'Crvena zona (Zona 1)', es: 'Zona Roja', de: 'Rote Zone', ru: 'Красная зона', zh: '红色区域' }, fee: '60 RSD / hr', duration: 'Max 1 hr', sms: '9111' },
  { id: 'yellow', name: { en: 'Yellow Zone (Zone 2)', sr: 'Žuta zona (Zona 2)', es: 'Zona Amarilla', de: 'Gelbe Zone', ru: 'Желтая зона', zh: '黄色区域' }, fee: '48 RSD / hr', duration: 'Max 2 hr', sms: '9112' },
  { id: 'green', name: { en: 'Green Zone (Zone 3)', sr: 'Zelena zona (Zona 3)', es: 'Zona Verde', de: 'Grüne Zone', ru: 'Зеленая зона', zh: '绿色区域' }, fee: '41 RSD / hr', duration: 'Max 3 hr', sms: '9113' },
  { id: 'blue', name: { en: 'Blue Zone (No limit)', sr: 'Plava zona (Bez limita)', es: 'Zona Azul', de: 'Blaue Zone', ru: 'Синяя зона', zh: '蓝色区域' }, fee: '31 RSD / hr', duration: 'No limit', sms: '9119' },
];
...
export function ConciergeSOSHub({ language }: { language: string }) {
  ...
  const content: Record<string, any> = {
    en: {
      ...
      subtitle: "Crisis numbers, authenticated premium transport, parking tools and diplomatic support.",
      ...
      taxi_tip: "Only use taxi stands with TX license plates. Avoid unsolicited drivers at exit gates.",
      ...
      parking_sub: "SMS to designated code based on area paint colors. Free after 9:00 PM and Sundays.",
      ...
      sms_helper: "Your phone will open Messages. Review and send the SMS yourself.",
      sms_fallback: "SMS not opening? Copy the details and send manually."
    },
    sr: {
      title: "SOS i putna asistencija",
      subtitle: "Hitne službe, sertifikovani gradski prevoz, servis za parking i diplomatska predstavništva.",
      ...
      english_notice: "Operateri govore srpski, engleski i jezike zemalja učesnica EXPO.",
      taxi_title: "Sertifikovana taksi udruženja",
      taxi_tip: "Koristite isključivo vozila sa 'TX' na registarskim tablicama. Izbegavajte divlje taksiste.",
      ...
      parking_sub: "Pošaljite SMS sa tablicama na određen broj u zavisnosti od boje zone na asfaltu.",
      ...
      sms_helper: "Vaš telefon će otvoriti Poruke. Pregledajte i sami pošaljite SMS.",
      sms_fallback: "SMS se ne otvara? Kopirajte podatke i pošaljite ručno."
    },
    es: {
      title: "Soporte de Viaje & SOS",
      subtitle: "Números de rescate, transporte de lujo avalado, asistente de parking y consulados.",
      ...
      english_notice: "Los operadores disponen de inglés y lenguas oficiales de la EXPO.",
      taxi_title: "Flotas de Taxis Certificadas",
      taxi_tip: "Haga uso de vehículos con placas certificadas 'TX'. Evite reclutas informales.",
      ...
      parking_sub: "Envie un SMS con su patente según el color pintado en el suelo. Gratis tras las 21H.",
      ...
      sms_helper: "Se abrirá la aplicación de Mensajes. Revise y envíe el SMS usted mismo.",
      sms_fallback: "¿No se abre el SMS? Copie los detalles y envíelo manualmente."
    },
    de: {
      title: "SOS & Reiseunterstützung",
      subtitle: "Notfallnummern, lizensierter Transport, Parkgebühr-Assistent und Botschaften.",
      ...
      english_notice: "Die Mitarbeiter sprechen Serbisch, Englisch und wichtige Messesprachen.",
      taxi_title: "Sichere Taxi-Dienste",
      taxi_tip: "Nutzen Sie nur Fahrzeuge mit 'TX'-Kennzeichen am Ende. Niemals freie Fahrer ansprechen.",
      ...
      parking_sub: "Senden Sie Ihr Kennzeichen per SMS an den Zonen-Code. Kostenlos nach 21 Uhr.",
      ...
      sms_helper: "Ihre Nachrichten-App wird geöffnet. Bitte prüfen und senden Sie die SMS selbst.",
      sms_fallback: "SMS öffnet sich nicht? Kopieren Sie die Daten und senden Sie manuell."
    },
    ru: {
      title: "Центр помощи и SOS-консьерж",
      subtitle: "Телефоны спасения, сертифицированный транспорт, парковка и посольства.",
      ...
      english_notice: "Операторы поддерживают сербский, английский и официальные языки ЭКСПО.",
      taxi_title: "Лицензированные службы такси",
      taxi_tip: "Выбирайте машины исключительно с буквами 'TX' на номерах во избежание обмана.",
      ...
      parking_sub: "Отправьте SMS с госмером на номер зоны. Бесплатно после 21:00 и по воскресеньям.",
      ...
      sms_helper: "Ваш телефон откроет приложение сообщений. Пожалуйста, проверьте и отправьте SMS самостоятельно.",
      sms_fallback: "SMS не открывается? Скопируйте данные и отправьте вручную."
    },
    zh: {
      title: "尊享领事保护与应急支持",
      subtitle: "提供即时紧急联络、世博认证安全交通、离线停车助手和外交领保通道。",
      ...
      taxi_tip: "请务必选乘车牌尾号带有“TX”的正规车辆。严禁搭乘航站楼外的无证拉客车。",
      taxi_button: "一键呼叫",
      ...
      parking_sub: "请输入完整车牌发至对应颜色代表的短信编码。工作日21点后及周日全天免费。",
    ...
    <div className="bg-[#FAF9F5] border border-[#E7E4DB] rounded-[32px] p-6 space-y-6 shadow-sm text-left">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-[10px] uppercase tracking-[0.25em] text-brand-charcoal font-black">{l.title}</h4>
        </div>
      ...
      <div className="space-y-3 pt-1">
        <div className="flex items-center gap-1.5">
          ...
          <p className="text-[9px] uppercase tracking-widest text-[#8C8A7D] font-extrabold">{l.emergency_title}</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div className="bg-white border border-[#E7E4DB] hover:border-accent-red p-3.5 rounded-2xl flex items-center justify-between transition-all group">
            <div className="min-w-0">
              <p className="text-[10px] font-sans font-semibold text-brand-charcoal">{l.universal_rescue}</p>
              <p className="text-15px font-serif text-accent-red font-black tracking-tight">112</p>
            </div>
            <a 
              href="tel:112"
          ...
          <div className="bg-white border border-[#E7E4DB] hover:border-accent-red p-3.5 rounded-2xl flex items-center justify-between transition-all group">
            <div className="min-w-0">
              <p className="text-[10px] font-sans font-semibold text-brand-charcoal">{l.police}</p>
              <p className="text-15px font-serif text-brand-charcoal font-bold tracking-tight">192</p>
            </div>
            <a 
              href="tel:192"
              onClick={() => triggerHaptic(15)}
          ...
          <div className="bg-white border border-[#E7E4DB] hover:border-accent-red p-3.5 rounded-2xl flex items-center justify-between transition-all group">
            <div className="min-w-0">
              <p className="text-[10px] font-sans font-semibold text-brand-charcoal">{l.fire}</p>
              <p className="text-15px font-serif text-brand-charcoal font-bold tracking-tight">193</p>
            </div>
            <a 
              href="tel:193"
              onClick={() => triggerHaptic(15)}
          ...
          <div className="bg-white border border-[#E7E4DB] hover:border-accent-red p-3.5 rounded-2xl flex items-center justify-between transition-all group">
            <div className="min-w-0">
              <p className="text-[10px] font-sans font-semibold text-brand-charcoal">{l.medical}</p>
              <p className="text-15px font-serif text-brand-charcoal font-bold tracking-tight">194</p>
            </div>
            <a 
              href="tel:194"
              onClick={() => triggerHaptic(15)}
          ...
          <div className="bg-white border border-[#E7E4DB] hover:border-accent-red p-3.5 rounded-2xl flex items-center justify-between transition-all group">
            <div className="min-w-0">
              <p className="text-[10px] font-sans font-semibold text-brand-charcoal">{l.road_assist}</p>
              <p className="text-15px font-serif text-brand-charcoal font-bold tracking-tight">1987</p>
            </div>
            <a 
              href="tel:1987"
              onClick={() => triggerHaptic(15)}
      ...
      <div className="pt-2 border-t border-[#F0EDE6] space-y-3">
        <div className="flex items-center gap-1.5">
          ...
          <p className="text-[9px] uppercase tracking-widest text-[#8C8A7D] font-extrabold">{l.parking_title}</p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {ZONES.map((zone) => {
              ...
              return (
                ...
                >
                  <div className={`w-2.5 h-2.5 rounded-full ${zoneColorHex} shrink-0`} />
                  <div className="min-w-0">
          ...
          {plateNumber.length > 2 && (
            <div className="space-y-3">
              <div className="flex items-center gap-1.5 bg-[#FAF9F5] border border-dashed border-[#E7E4DB] p-3 rounded-xl justify-between">
                <div>
                  <p className="text-[8px] uppercase font-black tracking-widest text-[#8C8A7D] leading-none">SMS Recipient Number</p>
                  <p className="text-[13.5px] font-mono text-brand-charcoal font-black mt-0.5">
                    {ZONES.find(z => z.id === selectedZone)?.sms}
                  </p>
                  <p className="text-[8px] uppercase font-black tracking-widest text-[#8C8A7D] mt-1.5 leading-none">SMS Content Body</p>
                ...
                >
                  {copiedText === 'sms' ? <Check size={11} /> : <Copy size={11} />}
                  <span>{copiedText === 'sms' ? l.copied : l.copy_directive}</span>
                </button>
              </div>
      ...
      <div className="pt-2 border-t border-[#F0EDE6] space-y-3">
        <div className="flex items-center gap-1.5">
          <Car size={11} className="text-[#8C8A7D]" />
          <p className="text-[9px] uppercase tracking-widest text-[#8C8A7D] font-extrabold">{l.taxi_title}</p>
        </div>
        ...
        <div className="bg-white border border-[#E7E4DB] rounded-2xl p-4 space-y-3 shadow-xs">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-[#FAF9F5] border border-[#E7E4DB] hover:border-[#D5D3C8] rounded-xl flex items-center justify-between">
              <div className="min-w-0">
                <p className="text-[11px] font-sans font-bold text-brand-charcoal">Pink Taxi Belgrade</p>
                <p className="text-[10px] text-[#8C8A7D] mt-0.5">Fleet dial: 19803 / Viber available</p>
              </div>
              <a 
                href="tel:19803"
                onClick={() => triggerHaptic(15)}
            ...
            <div className="p-3 bg-[#FAF9F5] border border-[#E7E4DB] hover:border-[#D5D3C8] rounded-xl flex items-center justify-between">
              <div className="min-w-0">
                <p className="text-[11px] font-sans font-bold text-brand-charcoal">Naxis Taxi Belgrade</p>
                <p className="text-[10px] text-[#8C8A7D] mt-0.5">Premium English: +381 11 6305555</p>
              </div>
              <a 
      ...
      <div className="pt-2 border-t border-[#F0EDE6] space-y-3">
        <div className="flex items-center gap-1.5">
          ...
          <p className="text-[9px] uppercase tracking-widest text-[#8C8A7D] font-extrabold">{l.embassy_title}</p>
        </div>
        ...
        <div className="bg-white border border-[#E7E4DB] rounded-2xl p-4 space-y-4 shadow-xs">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <ChevronDown size={11} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-brand-charcoal/40 pointer-events-none" />
            </div>
          </div>
          ...
          {activeEmbassy && (
            <div className="bg-[#FAF9F5] border border-[#E7E4DB] p-4 rounded-xl space-y-3.5 text-[11px]">
              <div>
                <p className="text-[8px] uppercase tracking-wider text-brand-charcoal/40 font-black leading-none">{activeEmbassy.name[language] || activeEmbassy.name.en}</p>
                <p className="text-[10px] uppercase font-black text-brand-charcoal mt-2.5 leading-none">{l.embassy_address}</p>
                <p className="font-semibold text-brand-charcoal/80 mt-1">{activeEmbassy.address}</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2 border-t border-[#F0EDE6]">
                <div className="space-y-0.5">
                  <span className="text-[9px] uppercase font-black text-[#8C8A7D] leading-none">{l.embassy_phone}</span>
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className="font-mono font-medium text-brand-charcoal">{activeEmbassy.phone}</span>
                    <a 
                ...
                <div className="space-y-0.5">
                  <span className="text-[9px] uppercase font-black text-accent-red leading-none">{l.embassy_sos}</span>
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className="font-mono font-bold text-accent-red">{activeEmbassy.emergencyPhone}</span>
                    <a 
