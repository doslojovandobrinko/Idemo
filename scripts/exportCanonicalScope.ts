...
fs.writeFileSync('./scripts/canonical_scope.json', JSON.stringify(exportData, null, 2));
console.log(`Exported ${exportData.length} canonical records to ./scripts/canonical_scope.json`);
