...
console.log(
  `Generating translations for ${canonicalRecs.length} canonical records...`,
);
...
function translateToSr(rec: any) {
  if (
    rec.translations?.sr?.title &&
    rec.translations?.sr?.shortDescription &&
    rec.translations?.sr?.longDescription
  ) {
    return {
  ...
  return {
    ...
    shortDescription:
      rec.translations?.sr?.shortDescription || rec.shortDescription,
    longDescription:
      rec.translations?.sr?.longDescription || rec.longDescription,
    location: rec.translations?.sr?.location || rec.location,
  };
}
...
function translateToZh(rec: any) {
  if (
    rec.translations?.zh?.title &&
    rec.translations?.zh?.shortDescription &&
    rec.translations?.zh?.longDescription
  ) {
    return {
  ...
  return {
    ...
    shortDescription:
      rec.translations?.zh?.shortDescription || rec.shortDescription,
    longDescription:
      rec.translations?.zh?.longDescription || rec.longDescription,
    location: rec.translations?.zh?.location || rec.location,
  };
}
...
function translateToDe(rec: any) {
  if (
    rec.translations?.de?.title &&
    rec.translations?.de?.shortDescription &&
    rec.translations?.de?.longDescription
  ) {
    return {
...
function translateToRu(rec: any) {
  if (
    rec.translations?.ru?.title &&
    rec.translations?.ru?.shortDescription &&
    rec.translations?.ru?.longDescription
  ) {
    return {
...
function translateToEs(rec: any) {
  if (
    rec.translations?.es?.title &&
    rec.translations?.es?.shortDescription &&
    rec.translations?.es?.longDescription
  ) {
    return {
