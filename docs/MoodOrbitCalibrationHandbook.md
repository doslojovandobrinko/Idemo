...
- **-3 (Reflective / Elegant):** Slow food, quiet traditional coffee houses (_kafanas_), museum walks, intimate wine cellar tastings.
...
- **+5 (Extreme Energy):** Electronic raves, extreme sports, midnight clubbing on floating barges (_splavovi_), heavy crowd events.
