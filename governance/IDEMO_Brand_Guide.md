...
- **No Infrastructure Noise:** Do not display technical container or server metrics (such as _"PORT: 3000"_, _"ONLINE"_, or _"CORE_NODE_ACTIVE"_) in user interfaces. This clutter belongs in server logs, not premium traveler cards.
